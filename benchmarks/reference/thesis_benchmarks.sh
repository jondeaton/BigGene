...
alignments="$HOME/Datasets/1000Genomes/bam/HG00096.mapped.ILLUMINA.bwa.GBR.low_coverage.20120522.bam"
duplicates="mkdups.adam"
bqsr="bqsr.adam"
...
adam-submit -- transformAlignments "$bam" 
	aln.adam \
	bqsr.adam \
